...
using SimRacingSdk.Ace.Udp.Extensions;
...
internal class AceUdpMessageHandler
{
    ...
    private readonly LogMessageBroker logMessageBroker = new(nameof(AceUdpMessageHandler));
    ...
    internal AceUdpMessageHandler(string connectionIdentifier)
    {
